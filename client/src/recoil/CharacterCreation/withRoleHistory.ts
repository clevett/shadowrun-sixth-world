...
export const CHARACTER_CREATION_OUTLOOK = selector({
  ...
  get: ({ get }) => {
    return {
      injustice: get(CHARACTER_CREATION_OUTLOOK_INJUSTICE),
      substances: get(CHARACTER_CREATION_OUTLOOK_SUBSTANCES),
      trafficking: get(CHARACTER_CREATION_OUTLOOK_TRAFFICKING),
      wetwork: get(CHARACTER_CREATION_OUTLOOK_WETWORK),
    }
  }
})
